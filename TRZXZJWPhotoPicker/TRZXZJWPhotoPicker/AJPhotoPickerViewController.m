...
@property (weak, nonatomic) UIButton *customCancelBtn;
...
//    [UIColor colorWithRed:236.0/255.0 green:66.0/255.0 blue:67.0/255.0 alpha:1.0];
...
-(void)changeNavigationColor{
    ...
    [self.customCancelBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.customCancelBtn.superview.backgroundColor = [UIColor colorWithRed:55/255.0 green:54/255.0 blue:59/255.0 alpha:1];
